...
import type { PricingTier, Testimonial, FAQ, Project, Industry } from "@/lib/supabase/content";
...
const Index = ({ faqItems, reviewItems, pricingTiers, featuredProjects, industries }: IndexProps) => (
  <Layout>
    <Hero />
    <TrustBar />
    <ProblemSection />
