          ...
          <div className="container-narrow">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {commonIssues.map((issue, i) => (
                <motion.div key={issue.title} custom={i} variants={cardVariant} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} whileHover={{ y: -4 }} className="bg-card rounded-2xl p-6 border border-border h-full">
          ...
          <div className="container-narrow">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {relatedBrands.map((rb, i) => (
                <motion.div key={rb.slug} custom={i} variants={cardVariant} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} whileHover={{ y: -4 }}>
