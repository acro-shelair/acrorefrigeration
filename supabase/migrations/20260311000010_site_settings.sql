...
create table site_settings (
  ...
  email                text not null default 'info@acrorefrigeration.com.au',
  address              text not null default 'Brisbane, SE Queensland',
  abn                  text not null default '43 672 578 264',
  tagline              text not null default 'Australia''s trusted commercial refrigeration contractor. 24/7 emergency repairs, maintenance plans and cold room builds across SE Queensland.',
  facebook_url         text not null default 'https://www.facebook.com/acrorefrigeration/',
  linkedin_url         text not null default 'https://www.linkedin.com/company/acro-refrigeration-qld/',
