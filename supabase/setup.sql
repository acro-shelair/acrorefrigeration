...
('danfoss', 'Danfoss',
 ...
 'Controls & Valves',
 'Global leader in refrigeration controls, valves and drives found in virtually every commercial refrigeration system.',
...
('Mark Thompson', 'Operations Manager, FreshMart',
 'Acro delivered our 200sqm cold storage facility two weeks ahead of schedule. The smart monitoring system has already prevented two potential temperature events.', 0),
...
('David Russo',   'Warehouse Director, PharmaLogix',
 'We needed pharmaceutical-grade cold storage with zero tolerance for temperature deviation. Acro engineered a system that''s been flawless for 18 months.', 2);
...
('Do you service all refrigeration brands?',
 'Yes. Our technicians are trained and equipped to service, repair, and maintain all major commercial refrigeration brands including Bitzer, Copeland, Danfoss, Daikin, and more.', 1),
...
((select id from inserted),'Our Approach',array['Acro Refrigeration''s project team began with a detailed site survey and thermal modelling exercise, using the store''s trading data to accurately size each refrigeration system for peak load conditions.','We specified 150mm PU foam panels for the blast freezer and 100mm panels for the remaining zones, with all inter-zone walls designed to provide thermal breaks.','For the pharmaceutical unit, we installed a redundant monitoring system with dual temperature probes, UPS-backed alarms and cloud-connected logging required for TGA compliance.'],2),
((select id from inserted),'The Result',array['The installation was completed in 12 weeks — two weeks ahead of the contracted schedule — allowing FreshMart''s fitout team additional time before the store opening. All four zones passed temperature validation and HACCP inspection on the first attempt.','Twelve months post-installation, all systems are operating at specification. FreshMart has since engaged Acro Refrigeration on a quarterly maintenance contract across all four stores.'],3),
...
with inserted as (
  insert into posts (slug, type, title, description, meta_description, date, read_time, related_slugs, published) values
  ('smart-monitoring-roi','Article','Smart Monitoring Systems: ROI for Commercial Refrigeration',
