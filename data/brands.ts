...
export const brandsPage = {
  ...
  subheading:
    "We service and repair every major commercial refrigeration brand — from compressor overhauls to control system diagnostics. If it's refrigeration, we know it.",
  emergencyBanner: {
  ...
  otherBrandsSubheading:
    "Our technicians are trained across the full range of commercial refrigeration equipment — whatever brand you run, we can help.",
  notListedHeading: "Don't See Your Brand?",
  notListedDesc:
    "We service and repair virtually all commercial refrigeration brands. If you don't see your equipment listed, get in touch — chances are we've worked on it before.",
};
...
export const brandsHomeSection = {
  ...
  heading: "All Major Brands. One Expert Team.",
  subheading:
    "We service and repair every major commercial refrigeration brand — from compressor overhauls to control system diagnostics.",
};
